...
import com.quicksync.twitter.net.Connection;
...
import com.quicksync.twitter.util.SharedPreferencesUtil;
...
public class TwitterUser {
    ...
    private static boolean isUsernameValid(String username) {
        ...
        if (username != null && (username.length() > 0)) {
            ...
            if (!ok && Log.isLoggable(QuicksyncService.APPTAG, Log.INFO)) {
