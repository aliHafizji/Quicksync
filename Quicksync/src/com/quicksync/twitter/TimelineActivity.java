...
public class TimelineActivity extends ListActivity implements ITimelineActivity {
    ...
    /**
     * TODO: enum from
     * com.quicksync.andtweet.data.AndTweetDatabase.Tweets.TIMELINE_TYPE_...
     */
    ...
    private void clearNotifications() {
        try {
            ...
            Intent intent = new Intent(QuicksyncService.ACTION_APPWIDGET_UPDATE);
            intent.putExtra(QuicksyncService.EXTRA_MSGTYPE, QuicksyncService.NOTIFY_CLEAR);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.favorites_timeline_menu_id:
                ...
                intent.putExtra(QuicksyncService.EXTRA_TIMELINE_TYPE,
                        QuicksyncDatabase.Tweets.TIMELINE_TYPE_FAVORITES);
    ...
    private void setTimelineType(Intent intentNew) {
        int timelineType_new  = intentNew.getIntExtra(QuicksyncService.EXTRA_TIMELINE_TYPE,
        ...
        if (mTimelineType == Tweets.TIMELINE_TYPE_NONE) {
            ...
            intent.putExtra(QuicksyncService.EXTRA_TIMELINE_TYPE, mTimelineType);
            intent.setData(QuicksyncDatabase.Tweets.CONTENT_URI);
       }
        if (Log.isLoggable(QuicksyncService.APPTAG, Log.VERBOSE)) {
