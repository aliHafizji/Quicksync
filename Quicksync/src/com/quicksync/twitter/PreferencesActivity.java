...
import com.quicksync.twitter.net.ConnectionCredentialsOfOtherUserException;
import com.quicksync.twitter.net.ConnectionException;
import com.quicksync.twitter.net.ConnectionOAuth;
import com.quicksync.twitter.net.ConnectionUnavailableException;
import com.quicksync.twitter.net.OAuthKeys;
...
public class PreferencesActivity extends PreferenceActivity implements
    ...
    private void showUserProperties() {
        ...
        if (mUser.getCredentialsVerified() == CredentialsVerified.SUCCEEDED) {
            sb = new StringBuilder(
                    this
                            .getText((com.quicksync.twitter.util.Build.VERSION.SDK_INT >= 8) ? R.string.summary_preference_credentials_verified
            ...
            if (com.quicksync.twitter.util.Build.VERSION.SDK_INT >= 8) {
    ...
    protected void onPause() {
        ...
        QuicksyncServiceManager.startAndTweetService(this);
