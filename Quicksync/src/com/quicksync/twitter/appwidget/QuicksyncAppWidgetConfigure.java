 ...
 */
public class QuicksyncAppWidgetConfigure extends Activity {
	static final String TAG = QuicksyncAppWidgetConfigure.class.getSimpleName();

	int mAppWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID;
	EditText mAppWidgetTitle;
	QuicksyncAppWidgetData appWidgetData;

	public QuicksyncAppWidgetConfigure() {
		super();
	}
	...
	public void onCreate(Bundle icicle) {
		...
		appWidgetData = new QuicksyncAppWidgetData(this,
				mAppWidgetId);
		appWidgetData.load();
