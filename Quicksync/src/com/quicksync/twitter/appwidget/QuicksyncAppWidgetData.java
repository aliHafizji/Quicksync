 ...
 */
public class QuicksyncAppWidgetData {
	private static final String TAG = QuicksyncAppWidgetData.class
			.getSimpleName();
	 ...
	 * "/data/data/com.quicksync.twitter/shared_prefs/"
	 * */
	...
	public QuicksyncAppWidgetData(Context context, int appWidgetId) {
		mContext = context;
